...
class SRSwiftyPopoverView : UIView{
    ...
    private let maxLabelHeight : CGFloat = UIDevice.current.userInterfaceIdiom == .pad ? 150.0 : 80.0
    ...
    fileprivate let cellHeight = UIDevice.current.userInterfaceIdiom == .pad ? 100.0 : 50.0
    ...
    private let tempConstantTopHeightLandscape = UIDevice.current.userInterfaceIdiom == .pad ? CGFloat(60) : CGFloat(60)
    private let screenSizeProportionHeight : CGFloat = 0.50
    ...
    private lazy var textLabel : UILabel = {
        ...
        lzyLabel.font = UIFont(name: "Montserrat-Regular", size: 18.0)
        return lzyLabel
    }()
    ...
    private(set) public lazy var tblView : UITableView = {
        ...
        lzyTableview.separatorInset = UIEdgeInsets.init(top: 0, left: 5, bottom: 0, right: 5)
    ...
    private func addNotifications(){
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(orientationChangeNoticed(_:)), name: UIDevice.orientationDidChangeNotification, object: nil)
    }
    ...
    private func setupLayerConstraints(){
        ...
        if blurViewDetails != nil {
            ...
            case .vibrant:
                let vibrant = UIBlurEffect(style: UIBlurEffect.Style.extraLight)
    ...
    func SR_DarkColorScheme(){
        ...
        self.currentColorScheme.tableviewSeperatorColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 0.5)
...
extension SRSwiftyPopoverView : UITableViewDelegate,UITableViewDataSource{
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        guard let newCell = cell else {
            ...
            c.textLabel?.font = UIFont(name: "Montserrat-Regular", size: 18.0)
