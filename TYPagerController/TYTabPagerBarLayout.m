...
- (void)configurePropertys
{
    ...
    _normalTextFont = [UIFont fontWithName:@"Montserrat-Regular" size:18.0f];
    _selectedTextFont = [UIFont fontWithName:@"Montserrat-Regular" size:18.0f];
...
- (void)transitionFromCell:(UICollectionViewCell<TYTabPagerBarCellProtocol> *)fromCell toCell:(UICollectionViewCell<TYTabPagerBarCellProtocol> *)toCell animate:(BOOL)animate {
    ...
    void (^animateBlock)(void) = ^{
        ...
        if (toCell) {
            toCell.titleLabel.font = self->_normalTextFont;
