...
class FavSeries: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,GADBannerViewDelegate,GADInterstitialDelegate
{
    ...
    override func viewWillAppear(_ animated: Bool)
    {
        ...
        //=======Get Favourite Series Data========//
        self.FavouriteArray.removeAllObjects()
        self.getAllSeriesData()
    }
    
    func getAllSeriesData()
    {
        self.FavouriteArray = Singleton.getInstance().getAllSeriesQueryData()
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell
    {
        ...
        let strimgpath : String? = (self.FavouriteArray.value(forKey: "series_poster") as! NSArray).object(at: indexPath.row) as? String
        ...
        cell.lblSeriesName?.text = (self.FavouriteArray.value(forKey: "series_name") as! NSArray).object(at: indexPath.row) as? String
    ...
    {
        let seriesID = (self.FavouriteArray.value(forKey: "id") as! NSArray).object(at: indexPath.row) as? String
        UserDefaults.standard.set(seriesID, forKey: "SERIES_ID")
        let seriesNAME = (self.FavouriteArray.value(forKey: "series_name") as! NSArray).object(at: indexPath.row) as? String
