...
class FavChannels: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,GADBannerViewDelegate,GADInterstitialDelegate
{
    ...
    override func viewWillAppear(_ animated: Bool)
    {
        ...
        //=======Get Favourite Channels Data========//
        self.FavouriteArray.removeAllObjects()
        self.getAllChannelsData()
    }
    
    func getAllChannelsData()
    {
        self.FavouriteArray = Singleton.getInstance().getAllChannelsQueryData()
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell
    {
        ...
        let strimgpath : String? = (self.FavouriteArray.value(forKey: "channel_thumbnail") as! NSArray).object(at: indexPath.row) as? String
        ...
        cell.lblChannelName?.text = (self.FavouriteArray.value(forKey: "channel_title") as! NSArray).object(at: indexPath.row) as? String
    ...
    {
        let channelID = (self.FavouriteArray.value(forKey: "id") as! NSArray).object(at: indexPath.row) as? String
        UserDefaults.standard.set(channelID, forKey: "CHANNEL_ID")
        let channelNAME = (self.FavouriteArray.value(forKey: "channel_title") as! NSArray).object(at: indexPath.row) as? String
