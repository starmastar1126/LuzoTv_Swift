...
class ChannelTableCell: UITableViewCell,UICollectionViewDelegate
    ,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout
{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell
    {
        ...
        let strimgpath : String? = (self.CollectionArray.value(forKey: "channel_thumbnail") as! NSArray).object(at: indexPath.row) as? String
        ...
        cell.lblChannelName?.text = (self.CollectionArray.value(forKey: "channel_title") as! NSArray).object(at: indexPath.row) as? String
    ...
    {
        let channelID = (self.CollectionArray.value(forKey: "id") as! NSArray).object(at: indexPath.row) as? String
        UserDefaults.standard.set(channelID, forKey: "CHANNEL_ID")
        let channelNAME = (self.CollectionArray.value(forKey: "channel_title") as! NSArray).object(at: indexPath.row) as? String
        UserDefaults.standard.set(channelNAME, forKey: "CHANNEL_NAME")
        NotificationCenter.default.post(name: Notification.Name("ChannelCellClick"), object: nil, userInfo: ["id": channelID as Any])
    }
}
